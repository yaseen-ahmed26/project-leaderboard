...
var current_phase: Constants.Phase = Constants.Phase.MIDNIGHT
...
# Main
func start_day():
	current_phase = Constants.Phase.MORNING
	Signals.phase_changed.emit(current_phase)
		
func start_afternoon():
	current_phase = Constants.Phase.AFTERNOON
	seconds_elapsed = 0
...
func end_day():
	...
	current_phase = Constants.Phase.MIDNIGHT
